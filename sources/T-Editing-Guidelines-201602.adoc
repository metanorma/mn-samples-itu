...
[[a_3_1Terms_defined_elsewhere]]
=== Terms defined elsewhere

==== amendment <<b-ITU-T_A.1>>
...
[[a_3_1_6]]
==== implementers' guide <<b-ITU-T_A.1>> 
...
[[a_3_2Terms_defined_in_this_Recommendation]]
...
[[a_7Description_of_introductory_material_to_be_provided_by_the_author]]
...
[[a_8Description_of_core_material]]
...
2+.<h| Paired Recommendation \| International Standard (or "twin text"):
...
2+.<h| Series or sub-series of Recommendations:
...
2+.<h| Recommendation ITU-T Q.816 (2001) plus all amendments and corrigenda that apply to that base:
...
[[a_8_4Abbreviations_and_acronyms]]
=== Abbreviations and acronyms
...
[[a_8_6Recommendation_technical_content]]
...
If these documents are referenced, a format similar to that used in clause 2 should be used, with a slight difference in the formulation of the citation tag ("b-" is inserted at the start of the tag). <<fig8-2>> provides examples of bibliographic entries.
...
[[a_9_3Clause_number_and_titles]]
=== Clause numbers and titles

[[a_9_3_1Clause_numbers]]
==== Clause numbers
...
[[a_9_4Mathematical_expressions_and_symbols_formulae_equations_etc]]
=== Mathematical expressions and symbols (formulae, equations, etc.)

[[a_9_4_1Quantities_units_and_symbols]]
...
[[a_9_4_3Numbers_and_special_characters]]
...
[[a_9_6Notes_and_footnotes]]
=== Notes and footnotes

[[a_9_6_1Notes_and_footnotes_to_the_main_text]]
...
[[a_9_6_2Notes_to_tables_and_figures]]
...
[[a_9_7Citing_of_references]]
=== Citing of references

[[a_9_7_1References_within_the_same_Recommendation]]
...
[[a_9_7_2References_to_parts_of_another_Recommendation]]
==== References to parts of another Recommendation

When reference is made to text passages, tables, figures, equations, etc., in another Recommendation, the citation tag (see <<a_8_2References>>) of the referenced Recommendation should be included in the reference, e.g., "see Figure 1 of [b-ITU-T A.8]", "see clause 2 of [b-ITU-T A.4]" or "see clause 2.2.10 of [ITU-T A.5]".

[[a_9_8Formal_language_descriptions]]
=== Formal language descriptions

Formal language modules should be presented using only characters acceptable by the relevant compilers (including tabs, line returns, etc.). See <<a_9_2Fonts>> regarding the use of fonts for formal languages.

[[a_10Additional_guidance]]
== Additional guidance
...
[[a_B_3Best_practices_for_writing_definitions_within_ITU-T_Recommendations]]
=== Best practices for writing definitions within ITU-T Recommendations

[[a_B_3_1Use_of_existing_terminology]]
...
[[a_B_3_7Illustrations_within_definitions]]
...
[[a_B_3_8Symbols_and_abbreviations]]
...
[[a_B_3_10Variables_and_special_notations_catalogues_within_definitions]]
...
[[a_B_4Formatting_of_definitions]]
=== Formatting of definitions

Formatting requirements for definitions are illustrated in <<a_3Definitions>> and explained in <<a_8_3Definitions>> of this author's guide.
...
[[a_C_2Proposed_structure_for_URIs_defined_in_ITU-T_Recommendations]]
...
[[a_E_1Preferred_presentation_format]]
...
The text appears, then, as shown in the example given in <<figE_1>>.
...
|===
.<h| …
.<h| 6 Definition of the VBD mode of operation
.<h| …
.<a| and should consider the appropriate application of:
...
[[a_E_2Exceptions_to_the_above_presentation_format]]
...
[[a_E_3Numbering_new_clauses_tables_and_figures]]
...
[[a_E_3_1Deletion_od_a_clause_table_or_figure]]
...
[[a_E_3_2Insertion_of_a_clause_table_or_figure]]
...
http://essayinfo.com/essays/definition_essay.php[http://essayinfo.com/essays/definition\_essay.php] (Referenced 1.02.2016)
