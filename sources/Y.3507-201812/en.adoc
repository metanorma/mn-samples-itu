...
a|
* <<b-OCP_OBIOS>> describes how Intel Virtualization Technology (Intel VT) must be supported via platform BIOS policy variable, in clause 4.8.
...
| Figure a|
[%unnumbered]
image::annex-figure-9.png[]

[%unnumbered]
image::annex-figure-10.png[]
